export const ALL_TRANSLATIONS = {
    ar: {
        ...
        landing: {
            ...
            aboutTitle: 'من نحن',
            aboutMission: 'مهمتنا',
            aboutMissionDesc: 'تنفيذ سياسة الدولة في مجال التكوين المهني الأساسي وتأهيل الشباب لسوق الشغل.',
            aboutVision: 'رؤيتنا',
            ...
            steps: [
                ...
                { title: 'ابحث عن تكوين', desc: 'تصفح أكثر من 400 اختصاص واختر ما يناسبك.', icon: 'search' },
            ...
            testimonials: [
                { name: 'أحمد بن سالم', role: 'خريج قسم المعلوماتية', quote: 'التكوين في ATFP غيّر حياتي المهنية. اليوم أعمل كمطور برمجيات.' },
                { name: 'فاطمة الزهراء', role: 'خريجة قسم التصميم', quote: 'المدربون كانوا ممتازين والمعدات حديثة. أنصح كل شاب بالتسجيل.' },
                { name: 'محمد العربي', role: 'خريج قسم الميكانيك', quote: 'بفضل التكوين التطبيقي، حصلت على شغل مباشرة بعد التخرج.' }
            ],
            // Final CTA
            ...
            // Enhanced Footer
            footerAbout: 'الوكالة التونسية للتكوين المهني توفر تكوينًا عالي الجودة لتأهيل الشباب التونسي.',
        ...
        about: {
            ...
            missionTitle: 'مهمتنا',
            missionDesc: 'تعمل الوكالة التونسية للتكوين المهني، تحت إشراف وزارة التشغيل والتكوين المهني، على تنفيذ سياسة الحكومة في مجال التكوين المهني الأساسي للشباب والعمال.',
            visionTitle: 'رؤيتنا',
            visionDesc: 'ضمان تكوين ذو جودة عالية يستجيب لحاجيات سوق الشغل ويفتح آفاقاً واسعة للشباب في تونس والخارج.',
            statsTitle: 'أرقامنا',
    ...
    fr: {
        ...
        landing: {
            ...
            heroSubtitle: 'Rejoignez l\'Agence Tunisienne de la Formation Professionnelle et maîtrisez un métier d\'avenir.',
            ctaSearch: 'Trouver une Formation',
            ctaRegister: 'S\'inscrire',
            // About Snapshot
            aboutTitle: 'Qui sommes-nous',
            aboutMission: 'Notre Mission',
            aboutMissionDesc: 'Mettre en œuvre la politique de l\'État dans le domaine de la formation professionnelle et qualifier les jeunes pour le marché du travail.',
            aboutVision: 'Notre Vision',
            aboutVisionDesc: 'Garantir une formation de haute qualité répondant aux besoins du marché et ouvrant des perspectives aux jeunes.',
            // Features (4)
            whyTitle: 'Pourquoi Choisir l\'ATFP ?',
            whySubtitle: 'Une formation de qualité pour une carrière réussie.',
            features: [
                { title: 'Diplômes Reconnus', desc: 'Certifications validées par l\'état et reconnues par les entreprises.' },
                { title: 'Formation Pratique', desc: 'Apprenez par la pratique avec des équipements modernes et des formateurs experts.' },
                { title: 'Large Réseau', desc: 'Plus de 136 centres de formation répartis sur tout le territoire.' },
                { title: 'Insertion Professionnelle', desc: 'Accompagnement à l\'emploi et partenariat avec les entreprises.' }
            ],
            // Stats (4)
            stats: {
                centers: 'Centres',
            ...
            steps: [
                { title: 'Créez votre compte', desc: 'Inscription gratuite en quelques minutes.', icon: 'person-plus' },
                { title: 'Trouvez une formation', desc: 'Parcourez plus de 400 spécialités et choisissez.', icon: 'search' },
                { title: 'Postulez', desc: 'Envoyez votre dossier et suivez-le en temps réel.', icon: 'send-check' }
            ],
            // Sectors
            ...
            testimonials: [
                { name: 'Ahmed Ben Salem', role: 'Diplômé en Informatique', quote: 'La formation à l\'ATFP a transformé ma carrière. Je travaille aujourd\'hui comme développeur.' },
                { name: 'Fatma Zahra', role: 'Diplômée en Design', quote: 'Les formateurs étaient excellents et les équipements modernes. Je recommande vivement.' },
                { name: 'Mohamed Arbi', role: 'Diplômé en Mécanique', quote: 'Grâce à la formation pratique, j\'ai trouvé un emploi dès l\'obtention de mon diplôme.' }
            ],
            // Final CTA
            ...
            // Enhanced Footer
            footerAbout: 'L\'ATFP offre une formation professionnelle de qualité pour préparer les jeunes Tunisiens au marché du travail.',
        ...
        about: {
            ...
            missionDesc: 'L\'Agence Tunisienne de la Formation Professionnelle met en œuvre la politique gouvernementale dans le domaine de la formation professionnelle initiale pour les jeunes et les travailleurs.',
            visionTitle: 'Notre Vision',
            visionDesc: 'Garantir une formation de haute qualité qui répond aux besoins du marché du travail et ouvre de larges perspectives pour les jeunes en Tunisie et à l\'étranger.',
        ...
        search: {
            ...
            subtitle: 'Découvrez les opportunités de formation et réalisez votre ambition professionnelle.',
            filters: {
